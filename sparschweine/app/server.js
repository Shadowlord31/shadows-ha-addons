...
require('./db/sparschweine'); // Schema wird beim ersten require angelegt

const app = express();
const PORT = process.env.PORT || 3003;

const INDEX_HTML_PATH = path.join(__dirname, 'public/sparschweine/index.html');
...
// fetch()-Pfade wie '/api/sparschweine' im Frontend wuerden diesen Prefix
// ignorieren und an HA Core statt an das Addon gehen. Deshalb wird der Praefix
// beim Ausliefern der HTML injiziert; das Frontend haengt ihn vor jeden API-Call.
...
app.listen(PORT, () => console.log(`Sparschweine: ${PORT}`));
